...
import com.seaboxdata.sdps.user.mybatis.mapper.SdpsValidateDaoMapper;
...
public class ValidateService{
    ...
    @Autowired
    private SdpsValidateDaoMapper validateDaoMapper;
...
//    }
     ...
     * @return
     */
    public int insertNewResetRecord(ValidateDao validateDao, SysUser userDao, String token){
        validateDao.setUserId(userDao.getId());
        validateDao.setEmail(userDao.getEmail());
        validateDao.setResetToken(token);
        validateDao.setType("passwordReset");
        validateDao.setGmtCreate(DateUtil.date());
        validateDao.setGmtModified(DateUtil.date());
