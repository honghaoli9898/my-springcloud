	...
	<aside class="main-sidebar" style="padding-top:0">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
                <li class="header" style="display:none">${I18n.system_nav}</li>
                <li class="nav-click <#if pageName == "index">active</#if>" ><a href="${request.contextPath}/index"><i class="fa fa-circle-o text-aqua"></i><span>${I18n.job_dashboard_name}</span></a></li>
