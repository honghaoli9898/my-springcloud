...
import com.seaboxdata.sdps.common.oauth2.converter.CustomUserAuthenticationConverter;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "sdps.oauth2.token.store", name = "type", havingValue = "resJwt")
public class ResJwtTokenStore {
    ...
    private String getKeyFromAuthorizationServer() {
        if (StrUtil.isNotEmpty(this.resource.getJwt().getKeyUri())) {
            ...
            return (String) new RestTemplate(RestTemplateUtil.generateHttpsRequestFactory())
