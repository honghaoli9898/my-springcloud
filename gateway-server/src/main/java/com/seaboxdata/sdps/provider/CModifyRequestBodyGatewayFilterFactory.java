//package com.seaboxdata.sdps.provider;
//
...
// */
//@Component
//public class CModifyRequestBodyGatewayFilterFactory extends
...
//					.flatMap(
//							originalBody -> modifyBody().apply(exchange,
...
//					exchange, headers);
//			return bodyInserter
//					.insert(outputMessage, new BodyInserterContext()).then(
//							Mono.defer(() -> {
