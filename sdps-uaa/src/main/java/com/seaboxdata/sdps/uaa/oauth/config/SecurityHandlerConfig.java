...
import com.seaboxdata.sdps.uaa.oauth.exception.ValidateCodeException;
import com.seaboxdata.sdps.uaa.oauth.handler.OauthLogoutHandler;
import com.seaboxdata.sdps.uaa.oauth.handler.OauthLogoutSuccessHandler;
    ...
    public WebResponseExceptionTranslator webResponseExceptionTranslator() {
        return new DefaultWebResponseExceptionTranslator() {
            ...
            public ResponseEntity<OAuth2Exception> translate(Exception e) throws Exception {
                ...
                finalResponse.getBody().addAdditionalInformation("code", oAuth2Exception.getHttpErrorCode() + "");
                finalResponse.getBody().addAdditionalInformation("msg", oAuth2Exception.getMessage());
